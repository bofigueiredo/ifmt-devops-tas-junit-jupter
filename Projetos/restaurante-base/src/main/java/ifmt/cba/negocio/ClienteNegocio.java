...
public class ClienteNegocio {
	...
	public ClienteNegocio(ClienteDAO clienteDAO, PedidoDAO pedidoDAO) {
	...
	public void excluir(int codigo) throws NegocioException {
		...
		try {
			...
			if (pedidoDAO.buscarPorCliente(cliente).size() > 0){
				throw new NegocioException("Nao pode excluir cliente relacionado com pedidos");
			}
