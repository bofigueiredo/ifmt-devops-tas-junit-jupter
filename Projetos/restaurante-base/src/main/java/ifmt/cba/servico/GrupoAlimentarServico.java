...
public class GrupoAlimentarServico {
    ...
    public Response adicionar(GrupoAlimentarDTO grupoAlimentarDTO) {
        ...
        try {
            ...
            resposta.entity(grupoAlimentarNegocio.pesquisaParteNome(grupoAlimentarDTO.getNome()).get(0));
        } catch (Exception ex) {
    ...
    public Response alterar(GrupoAlimentarDTO grupoAlimentarDTO) {
        ...
        try {
            ...
            resposta = Response.ok();
            resposta.entity(grupoAlimentarNegocio.pesquisaCodigo(grupoAlimentarDTO.getCodigo()));
        } catch (Exception ex) {
            resposta = Response.status(400);
            resposta.entity("{\"erro\": \""+ex.getMessage()+"\"}");
        }
